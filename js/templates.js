...
function program9(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push(" \n        </div>\n        <div class=\"isbn col-xs-12\">\n            <b><i class=\"fa fa-info-circle\"></i> ISBN: </b>\n             ");
  data.buffer.push(escapeExpression((helper = helpers.joinISBN || (depth0 && depth0.joinISBN),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "post.response.docs.0.dc_identifier_isbn", options) : helperMissing.call(depth0, "joinISBN", "post.response.docs.0.dc_identifier_isbn", options))));
  data.buffer.push(" \n        </div>\n        <div class=\"download col-xs-12\">\n          <div class=\"row\">\n              ");
  stack1 = helpers.each.call(depth0, "postLinks.response.docs", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(9, program9, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n          </div> <!-- end row --> \n        </div> <!-- end download --> \n      </div><!-- end row -->\n    </div> <!-- end single-post -->\n");
  return buffer;
